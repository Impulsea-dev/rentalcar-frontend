        ...
        <div class="shadow-sm">
            <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    <NuxtLink to="/" class="main-logo flex shrink-0 items-center">
                        ...
                        <span
                            class="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">Economy
                            Rental</span>
                    </NuxtLink>
            ...
            <ul
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <NuxtLink to="/apps/chat">chat</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/apps/mailbox">mailbox</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/apps/todolist">todo_list</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/apps/notes">notes</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/apps/scrumboard">scrumboard</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/apps/contacts">contacts</NuxtLink>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                ...
                                <li>
                                    <NuxtLink to="/apps/invoice/list">list</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/apps/invoice/preview">preview</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/apps/invoice/add">add</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/apps/invoice/edit">edit</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <NuxtLink to="/apps/calendar">calendar</NuxtLink>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <NuxtLink to="/components/accordions">accordions</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/modals">modals</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/cards">cards</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/carousel">carousel</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/countdown">countdown</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/counter">counter</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/sweetalert">sweet_alerts</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/timeline">timeline</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/notifications">notifications</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/media-object">media_object</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/list-group">list_group</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/pricing-table">pricing_tables</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/components/lightbox">lightbox</NuxtLink>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <NuxtLink to="/elements/alerts">alerts</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/avatar">avatar</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/badges">badges</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/breadcrumbs">breadcrumbs</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/buttons">buttons</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/buttons-group">button_groups</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/color-library">color_library</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/dropdown">dropdown</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/infobox">infobox</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/jumbotron">jumbotron</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/loader">loader</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/pagination">pagination</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/popovers">popovers</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/progress-bar">progress_bar</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/search">search</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/tooltips">tooltips</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/treeview">treeview</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/elements/typography">typography</NuxtLink>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <NuxtLink to="/tables">tables</NuxtLink>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                <li>
                                    <NuxtLink to="/datatables/basic">basic</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/advanced">advanced</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/skin">skin</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/order-sorting">order_sorting</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/columns-filter">columns_filter</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/multi-column">multi_column</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/multiple-tables">multiple_tables</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/alt-pagination">alt_pagination</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/checkbox">checkbox</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/range-search">range_search</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/export">export</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/sticky-header">sticky_header</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/clone-header">clone_header</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/datatables/column-chooser">column_chooser</NuxtLink>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <NuxtLink to="/forms/basic">basic</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/input-group">input_group</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/layouts">layouts</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/validation">validation</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/input-mask">input_mask</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/select2">select2</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/touchspin">touchspin</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/checkbox-radio">checkbox_and_radio</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/switches">switches</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/wizards">wizards</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/file-upload">file_upload</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/quill-editor">quill_editor</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/markdown-editor">markdown_editor</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/date-picker">date_and_range_picker</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/forms/clipboard">clipboard</NuxtLink>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li class="relative">
                            ...
                            <ul
                                ...
                                <li>
                                    <NuxtLink to="/users/user-account-settings">account_settings</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <NuxtLink to="/pages/knowledge-base">knowledge_base</NuxtLink>
                        </li>
                        <li>
                        ...
                        <li>
                            <NuxtLink to="/pages/maintenence" target="_blank">maintenence</NuxtLink>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                <li>
                                    <NuxtLink to="/pages/error404" target="_blank">404</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/pages/error500" target="_blank">500</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/pages/error503" target="_blank">503</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                <li>
                                    <NuxtLink to="/auth/cover-login" target="_blank">login_cover</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/auth/boxed-signin" target="_blank">login_boxed</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <NuxtLink to="/dragndrop">drag_and_drop</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/charts">charts</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/font-icons">font_icons</NuxtLink>
                        </li>
                        <li>
