<template>
    <div>
        <section class="h-screen text-center overflow-hidden bg-black">
            <div class="flex flex-col h-full relative">
                <HeroAnimation class="px-5">
                    <h2
                        class="text-white pt-32 md:pt-40 text-[48px] md:text-[64px] font-medium tracking-in-expand-forward-bottom pb-4">
